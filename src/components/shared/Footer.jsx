...
export function Footer() {
  ...
  {
    name: "X",
    href: "https://x.com/fefine_ai",
    hoverColor: "group-hover:text-white",
    path: "M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.933zm-1.292 19.49h2.039L6.486 3.24H4.298l13.311 17.403z"
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/ujjwaltiwari21",
    hoverColor: "group-hover:text-[#0077B5]",
    path: "M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"
  },
  {
    name: "GitHub",
    href: "https://github.com/ujjwaltiwari21",
    hoverColor: "group-hover:text-white",
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/CodeNova01",
  ...
  const navLinks = {
    social: [
      { name: "Instagram", href: "https://www.instagram.com/fefine.ai/", icon: "instagram" },
      { name: "X", href: "https://x.com/fefine_ai", icon: "x" },
      { name: "LinkedIn", href: "https://www.linkedin.com/in/ujjwaltiwari21", icon: "linkedin" },
      { name: "GitHub", href: "https://github.com/ujjwaltiwari21", icon: "github" },
    ],
    platform: [
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 md:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12 pb-8 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-2xl font-bold text-white tracking-tighter">Fefine<span className="text-blue-500">.</span>ai</span>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm text-slate-400">
                ...
                <a href="mailto:hello@Fefine.ai" className="hover:text-white transition-colors">hello@Fefine.ai</a>
              </div>
            </div>
        ...
        <div className="pt-6 pb-4 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-medium tracking-wider">
          <p className="text-slate-500">
            © {currentYear} Fefine AI. All rights reserved.
          </p>
